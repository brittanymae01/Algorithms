...
def find_max_profit(prices):
  #make a loop that iterates through for the lowest buying price
  #store the lowest buying price and highest selling price in a variable as an index
  #loop to find the highest profit price
  #highest - lowest check on each iteration
